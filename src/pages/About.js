...
const About = () => {
    return (
        ...
        animate={{opacity:1}}
        exit={{opacity:0}}
        className="bg-gradient-to-b min-h-screen from-slate-900  to-slate-950">
            ...
            <div className="z-10 relative container mx-auto py-12 px-4 ">
                ...
                >
                    <h1 className="text-4xl font-semibold text-teal-400 mb-2">CASUAL LEGENDS</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <motion.div
                        ...
                        className="border-teal-400 border bg-slate-900 bg-opacity-70 rounded-lg shadow-lg p-6"
                    >
                        <h2 className="text-2xl font-semibold text-white mb-4">Game Concept</h2>
                    ...
                    <motion.div
                        ...
                        className="border-teal-400 border bg-slate-900 bg-opacity-70 rounded-lg shadow-lg p-6"
                    >
                        <h2 className="text-2xl font-semibold text-white mb-4">AI Dungeon Master</h2>
                        <p className="text-lg text-white">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. In id tincidunt tellus, 
                        a blandit nibh. Nulla pellentesque quis sapien vel sodales. Quisque sed mauris quis ex malesuada aliquet a ut nibh.
                        Praesent eget eros a urna vestibulum pharetra. Mauris aliquet blandit nisl, a cursus arcu semper ut. Interdum et malesuada fames 
                ...
                <motion.div
                    ...
                    <h2 className="text-2xl font-semibold text-teal-400 mb-4">Team Members</h2>
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, delay: 0.2 }}
                        className="border-teal-400 border  bg-slate-900 bg-opacity-70 rounded-lg shadow-lg p-6 mb-4" >
                        <h3 className="text-lg font-semibold text-white">Ilya</h3>
                        <p className="text-white">Product Sorcerer</p>
                    </motion.div >
